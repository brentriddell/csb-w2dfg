...
export interface Message {
   ...
   */
  content: Array<Message.MessageContentImageFileObject | Message.MessageContentTextObject>;
   ...
   * Useful for tools like retrieval and code_interpreter that can access files. A
  ...
  /**
   * If applicable, the ID of the [run](/docs/api-reference/runs) associated with the
...
export interface MessageCreateParams {
  ...
  /**
   * A list of [File](/docs/api-reference/files) IDs that the message should use.
   * There can be a maximum of 10 files attached to a message. Useful for tools like
